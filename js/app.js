...
const loadPhoneDetails = async id =>{
  ...
  const res = await fetch(url);
  const data = await res.json();
  phoneDetailModalLabel(data.data);
}

const phoneDetailModalLabel = phone =>{
  console.log(phone);
  ...
  phoneDetail.innerHTML = `
    ...
    <p>others: ${phone.others ? phone.others.Bluetooth : 'no found bluetooth'}</p>
  `
}
